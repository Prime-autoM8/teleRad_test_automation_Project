@beSureToLogOut
Feature: Radiologist Save the Report
  This feature handles the Radiologist save the report


  # Radiologist saves report (BUG)
  @TE0030
  Scenario: Validate the Radiologist Save the Report
