...
//    Locator Objects
    ...
    By profileIconEx = By.xpath("(//div[@class='TopNavigation--header_right_profile'])[2]");
...
// Clear Wrong Entries
    ...
    public void system_displays_accept_reporting_popup() {
        wait.until(ExpectedConditions.visibilityOfElementLocated(acceptPopup));
        Assert.assertEquals(driver.findElement(acceptPopup).getText(), "Are you sure?");
    }
    ...
    public void the_user_clicks_the_profile_icon() throws InterruptedException {
        Thread.sleep(2000);
        wait.until(ExpectedConditions.elementToBeClickable(profileIconEx));
        driver.findElement(profileIconEx).click();
    }
